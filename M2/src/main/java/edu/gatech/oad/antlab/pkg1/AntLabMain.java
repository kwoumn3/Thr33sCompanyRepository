 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Chelsi Cocking");
		  toPrint += p1.toString("ccocking3");
		  
                  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Gabriel Galarza");
		  toPrint += p2.toString("ggalarza3");
		  
                  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Tre'Saun Thomas");
		  toPrint += p3.toString("tthomas45");
                  
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Kyle Woumn");
                  toPrint += p4.toString("kwoumn3");
                  
                  //Person5 replace P5 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Francisco Zampieri");
                  toPrint += p5.toString("fzampieri3");
